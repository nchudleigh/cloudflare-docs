...
- Use your Framework of choice, including [Vue](/workers/frameworks/framework-guides/vue/), [Svelt](/workers/frameworks/framework-guides/svelt/), [Astro](/workers/frameworks/framework-guides/astro/), [Remix](/frameworks/framework-guides/react-router/), [Next](/frameworks/framework-guides/nextjs/), [React](/workers/frameworks/framework-guides/react/), [and more](/workers/frameworks/)
...
You can also [get started locally with Cloudflare's Wrangler CLI](/workers/get-started/guide/)
...
Use Cloudflare's [CDN & cache](/cache/) for incredibly fast rendering anywhere in the world

#### Back-end applications

Connect to data stores with [Smart Placement](/workers/configuration/smart-placement/) to optimize latency

#### Serverless AI inference

Run LLMs, image generation, and more with [Workers AI](/workers-ai/)

#### Background jobs

Enable [cron jobs](/workers/configuration/cron-triggers/), [Workflows](/workflows/), and [Queues](/queues/)
